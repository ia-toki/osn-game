define(['testcase', 'storage'], function(testcase, storage) {
	var message = {
		getIDNHelp: function() {
			return  "Dalam permainan ini, anda diminta untuk mencari angka yang dipikirkan juri. Pilih angka-angka yang akan dijadikan himpunan yang akan ditebak, kemudian tekan tombol 'Submit Guess' dan program akan memberikan respon seperti yang dijelaskan di soal. Bila anda ingin menebak angka yang dipikirkan juri, maka klik tombol 'answer' dan masukkan angka jawaban anda." + '\n ' +'\n ' +
		...
		getENGHelp: function() {
			return  "In this game, you have to guess the jury's number. Enter the guessed set of number, and click 'submit guess', the program will give response as described in the problem. If you want to guess the jury's number, click on 'answer' button and input your guess." + '\n ' +'\n ' +
